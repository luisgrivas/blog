...
*Demostración:* Sea $A = \{y\in Y: \widetilde \phi_1 (y) = \widetilde \phi_2(y) \}$. Por hipótesis, $A$ es no vacío. Demostraremos que $A$ es abierto y cerrado. Puesto que $Y$ es conexo, esto implica que $A = Y$.  

Primero, sea $a \in A$. Entonces $\widetilde \phi_1(a) = \widetilde \phi_2 (a)$
